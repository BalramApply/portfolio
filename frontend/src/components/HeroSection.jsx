...
export const HeroSection = () => {
  ...
  return (
    <section id="hero" className="home-top">
      <div className="intro-text">
        <h2>Hello, I'm</h2>
        <h1>Balram Patel</h1>

        <p className="tagline">
          <span className="typewriter">Aspiring Full Stack Web Developer</span>
        </p>

        <p className="short-bio">
          Passionate about creating innovative solutions and building robust
          applications with modern technologies. I love turning ideas into
        ...
        <div className="home-actions">
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=balramapply123@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            title="Send Email"
          >
